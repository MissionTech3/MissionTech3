...
# Game Title
pygame.display.set_caption("SnakesWithLovanyuPal")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Created By Lovanyu Pal", black, 228, 100)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            gameWindow.fill(red)
            text_screen("  HighScore:  " + str(HighScore), black, 285, 160)
            text_screen("Score: " + str(score), black, 365, 205)
